...
class NoiseScheduleVP:
    def __init__(
        ...
        ***
        Update: We support discrete-time diffusion models by implementing a piecewise linear interpolation for log_alpha_t.
        ...
        ***
        ...
        2. For continuous-time DPMs:
            ...
            Args:
                continuous_beta_0: A `float` number. The smallest beta for the linear schedule.
                continuous_beta_1: A `float` number. The largest beta for the linear schedule.
    ...
    def numerical_clip_alpha(self, log_alphas, clipped_lambda=-5.1):
        """
        For some beta schedules such as cosine schedule, the log-SNR has numerical issues.
...
def model_wrapper(
    ...
    def get_model_input_time(t_continuous):
        ...
        For discrete-time DPMs, we convert `t_continuous` in [1 / N, 1] to `t_input` in [0, 1000 * (N 
...
class DPM_Solver:
    ...
    def data_prediction_fn(self, x, t):
        ...
        #originally the line below was :x0 = (x - sigma_t * noise) / alpha_t
        C = x.shape[1] 
        noise, var = torch.split(noise, C, dim=1)
    ...
    def sample(self, x, steps=20, t_start=None, t_end=None, order=2, skip_type='time_uniform',
        ...
        We support the following algorithms for both noise prediction model and data prediction model:
            ...
            - 'adaptive':
                ...
                You can adjust the absolute tolerance `atol` and the relative tolerance `rtol` to balance the computation costs
